...
class PauseSubState extends MusicBeatSubstate
{
	...
	public var menuItems:Array<String> = ['Resume', 'Restart Song', 'Options', 'Exit to menu'];
	...
	override function update(elapsed:Float)
	{
		...
		switch (daSelected)
		{
			...
			case 'downscroll':
				selectedString = "Change the way notes scroll.";
			case 'ghost tapping':
				selectedString = "Pressing a button without a note in contact.";
			case 'antialiasing':
				selectedString = "Whether to smoothen sharp lines at the cost of performance.";
			case 'music volume':
				selectedString = "Change the volume of the music.";
			case 'sound volume':
				selectedString = "Change the volume of the music.";
			case 'vocal volume':
				selectedString = "Change the volume of the music.";
	...
	function changeItems(focus:Int):Void
	{
		...
		switch (focus)
		{
			...
			case 3:
				menuItems = ['gameplay settings', 'downscroll', 'ghost tapping', 'note offset', 'Back'];
				changeableValues = [
					null,
			...
			case 4:
				menuItems = ['graphics settings', 'antialiasing', 'Back'];
				changeableValues = [null, FlxG.save.data.antialiasing, null];
				defaultValues = [null, true, null];
			case 5:
