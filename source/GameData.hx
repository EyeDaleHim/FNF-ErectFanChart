...
class GameData
{
	...
	public static final globalMusic:String = Paths.music('freakyMenu');
	...
	public static final modName = "FNFErect";

	// MAIN MENU
	// Menu Directional for the Menu.
	public static final menuStyle:MenuStyles = MenuStyles.MIDDLE;
	// Show the version?
